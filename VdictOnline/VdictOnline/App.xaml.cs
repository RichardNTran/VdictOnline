        ...
        public App()
        {
            ...
            using (ToDoDataContext db = new ToDoDataContext(DBConnectionString))
            {
                if (db.DatabaseExists() == false)
                {
                    ...
                    db.Categories.InsertOnSubmit(new ToDoCategory { Name = "English" });
                    db.Categories.InsertOnSubmit(new ToDoCategory { Name = "VietNam" });
                    db.Categories.InsertOnSubmit(new ToDoCategory { Name = "France" });
